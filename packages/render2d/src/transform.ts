 ...
 *
 * Geometry comes from `@perfboard-studio/core`; this module owns only the screen/viewport
 * layer on top of it.
 *
...
import type { Board, BoardSide, HoleCoord, Point2 } from '@perfboard-studio/core';
import { holeSpanMm, holeToMm } from '@perfboard-studio/core';
