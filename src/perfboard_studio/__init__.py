...
The package root stays deliberately thin -- importing ``perfboard_studio`` must not drag in
...
``perfboard_studio.version`` so that ``perfboard_studio.__version__`` works the way every other
