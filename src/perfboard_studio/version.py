...
def describe() -> str:
    ...
    format version is included because "which Perfboard Studio wrote this file" and "can this
    Perfboard Studio read that file" are different questions, and the second one is the one
    ...
    # isn't there.
    return (
        f"Perfboard Studio {__version__}"
