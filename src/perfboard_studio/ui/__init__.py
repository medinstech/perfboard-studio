...
(``perfboard_studio.model``), loaded via ``perfboard_studio.persist``, and every mutation is
dispatched through a ``perfboard_studio.command.CommandBus`` rather than written in place.
