...
Writes `src/perfboard_studio/ui/assets/`: `perfboard-studio.png` (256 px, for the AppImage and the
desktop entry) and `perfboard-studio.ico` (for the Windows executable and installer).
...
from perfboard_studio.ui.boardcolors import BY_KEY  # noqa: E402

OUT_DIR = REPO_ROOT / "src" / "perfboard_studio" / "ui" / "assets"
...
def main() -> int:
    ...
    png = OUT_DIR / "perfboard-studio.png"
    ...
    ico = OUT_DIR / "perfboard-studio.ico"
