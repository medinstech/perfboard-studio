...
Five finished circuits, each shipped twice: as the `.net` a schematic tool exports, and as
...
| **atmega328-relay** | 24 | **9 × 15 cm**, 34 × 58, FR-4 | Scale, and what it costs. An ATmega328 with a 7805, a crystal, a relay and four connectors: 24 nets, 52 conductors, a 76-step guide with 104 checkpoints and 49 wires to cut. It is also every rule at once — a TO-220 and a relay both run hot, two electrolytics mind, and the board's own finger strips are 64 holes nothing can be soldered into. |
...
All five route to completion, match their schematics under LVS, and carry no DRC error.
...
`atmega328-relay` names its seed as well. Annealing is a random walk and the outcome
