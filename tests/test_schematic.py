"""Tests for the generated schematic (src/perfboard_studio/schematic.py).
...
``tools/diffcheck/golden/``. Re-bless with ``PERFBOARD_STUDIO_BLESS_SCHEMATIC=1`` AFTER READING
...
from perfboard_studio import persist, schematic_export
